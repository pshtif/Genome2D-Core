    ...
    inline private function set_mouseDown(p_value:String):String {
        if (g2d_mouseDown != p_value) {
            if (g2d_mouseDown != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseDown.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseDown.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_mouseDown != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseDown.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseDown.add(mdf);
                    #end
                }
    ...
    inline private function set_rightMouseDown(p_value:String):String {
        if (g2d_rightMouseDown != p_value) {
            if (g2d_rightMouseDown != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onRightMouseDown.remove($bind(g2d_currentController, mdf));
                    #else
                    onRightMouseDown.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_rightMouseDown != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onRightMouseDown.add($bind(g2d_currentController, mdf));
                    #else
                    onRightMouseDown.add(mdf);
                    #end
                }
            }
        }
    ...
    inline private function set_mouseUp(p_value:String):String {
        if (g2d_mouseUp != p_value) {
            if (g2d_mouseUp != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseUp.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseUp.remove(mdf);
                    #end
                }
            }
            g2d_mouseUp = p_value;
            if (g2d_mouseUp != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseUp.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseUp.add(mdf);
                    #end
                }
    ...
    inline private function set_rightMouseUp(p_value:String):String {
        if (g2d_rightMouseUp != p_value) {
            if (g2d_rightMouseUp != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onRightMouseUp.remove($bind(g2d_currentController, mdf));
                    #else
                    onRightMouseUp.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_rightMouseUp != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onRightMouseUp.add($bind(g2d_currentController, mdf));
                    #else
                    onRightMouseUp.add(mdf);
                    #end
                }
            }
        }
    ...
    inline private function set_mouseWheel(p_value:String):String {
        if (g2d_mouseWheel != p_value) {
            if (g2d_mouseWheel != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseWheel.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseWheel.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_mouseWheel != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseWheel.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseWheel.add(mdf);
                    #end
                }
            }
        }
    ...
    inline private function set_mouseClick(p_value:String):String {
        if (g2d_mouseClick != p_value) {
            if (g2d_mouseClick != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseClick.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseClick.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_mouseClick != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseClick.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseClick.add(mdf);
                    #end
                }
            }
        }
    ...
    inline private function set_rightMouseClick(p_value:String):String {
        if (g2d_rightMouseClick != p_value) {
            if (g2d_rightMouseClick != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onRightMouseClick.remove($bind(g2d_currentController, mdf));
                    #else
                    onRightMouseClick.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_rightMouseClick != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onRightMouseClick.add($bind(g2d_currentController, mdf));
                    #else
                    onRightMouseClick.add(mdf);
                    #end
                }
            }
        }
    ...
    inline private function set_mouseOver(p_value:String):String {
        if (g2d_mouseOver != p_value) {
            if (g2d_mouseOver != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseOver.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseOver.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_mouseOver != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseOver.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseOver.add(mdf);
                    #end
                }
    ...
    inline private function set_mouseOut(p_value:String):String {
        if (g2d_mouseOut != p_value) {
            if (g2d_mouseOut != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseOut.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseOut.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_mouseOut != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseOut.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseOut.add(mdf);
                    #end
                }
    ...
    inline private function set_mouseMove(p_value:String):String {
        if (g2d_mouseMove != p_value) {
            if (g2d_mouseMove != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseMove.remove($bind(g2d_currentController, mdf));
                    #else
                    onMouseMove.remove(mdf);
                    #end
                }
            }
            ...
            if (g2d_mouseMove != "" && g2d_currentController != null) {
                ...
                if (mdf != null) {
                    #if js
                    untyped onMouseMove.add($bind(g2d_currentController, mdf));
                    #else
                    onMouseMove.add(mdf);
                    #end
                }
    ...
    public function render(p_red:Float = 1, p_green:Float = 1, p_blue:Float = 1, p_alpha:Float = 1):Void {
        if (visible) {
			...
			if (useMask) {
                ...
                if (intersection.width < 1 || intersection.height < 1) return;
		...
		if (visible) {
            ...
            if (!p_input.captured && p_input.worldX > g2d_worldLeft-mousePaddingLeft && p_input.worldX < g2d_worldRight+mousePaddingRight && p_input.worldY > g2d_worldTop-mousePaddingTop && p_input.worldY < g2d_worldBottom+mousePaddingBottom) {
                if (g2d_activeSkin != null) {
                    ...
                    else if (p_input.type == GMouseInputType.RIGHT_MOUSE_DOWN) setRightMouseDownElement(this, p_input);

                    else if (p_input.type == GMouseInputType.RIGHT_MOUSE_UP) setRightMouseUpElement(this, p_input);
            ...
            switch (p_input.type) {
                ...
                case GMouseInputType.RIGHT_MOUSE_UP:
                    if (g2d_root.g2d_rightMouseUpElement == null && g2d_root.g2d_rightMouseDownElement != null) {
                        g2d_root.g2d_rightMouseDownElement.g2d_dispatchMouseCallback(GMouseInputType.RIGHT_MOUSE_UP, g2d_root.g2d_rightMouseDownElement, g2d_root.g2d_rightMouseDownElement, p_input, false);
                    } else if (g2d_root.g2d_rightMouseUpElement != null && g2d_root.g2d_rightMouseDownElement == g2d_root.g2d_rightMouseUpElement) {
                        g2d_root.g2d_rightMouseDownElement.g2d_dispatchMouseCallback(GMouseInputType.RIGHT_MOUSE_UP, g2d_root.g2d_rightMouseDownElement, g2d_root.g2d_rightMouseDownElement, p_input, false);
                        g2d_root.g2d_rightMouseDownElement.g2d_dispatchMouseCallback(GMouseInputType.RIGHT_CLICK, g2d_root.g2d_rightMouseDownElement, g2d_root.g2d_rightMouseDownElement, p_input, false);
                    } else if (g2d_root.g2d_mouseUpElement != null) {
                        g2d_root.g2d_rightMouseUpElement.g2d_dispatchMouseCallback(GMouseInputType.RIGHT_MOUSE_UP, g2d_root.g2d_rightMouseUpElement, g2d_root.g2d_rightMouseUpElement, p_input, false);
                    }
        ...
        if (isVisible() || p_type == GMouseInputType.MOUSE_OUT) {
            ...
            switch (p_type) {
                ...
                case GMouseInputType.CLICK:
                    if (mouseEnabled && (g2d_onMouseClick != null || g2d_onDoubleMouseClick != null)) {
                ...
                // RIGHT BUTTON
                case GMouseInputType.RIGHT_MOUSE_DOWN:
                    if (mouseEnabled && g2d_onRightMouseDown != null) g2d_onRightMouseDown.dispatch(mouseInput);
                case GMouseInputType.RIGHT_MOUSE_UP:
                    if (mouseEnabled && g2d_onRightMouseUp != null) g2d_onRightMouseUp.dispatch(mouseInput);
                case GMouseInputType.RIGHT_CLICK:
